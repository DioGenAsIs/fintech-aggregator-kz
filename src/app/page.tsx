    ...
    <div className="min-h-screen bg-slate-50 text-slate-900">
            ...
            {[
              {
                ...
                text: "Сравните условия и откройте подходящий оффер.",
              },
              {
                icon: Landmark,
                title: "Перейдите на сайт кредитора",
                text: "Мы перенаправим вас на официальную страницу заявки.",
              },
              {
                icon: Clock3,
                title: "Заполните заявку онлайн",
                text: "Оставьте данные и дождитесь решения кредитной организации.",
              },
        ...
        <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm sm:p-7">
          ...
          <div className="mt-5 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {[
              {
                icon: ShieldCheck,
                text: "Сравнение предложений в одном месте",
              },
              {
                icon: Clock3,
                text: "Быстрый переход к заявке",
              },
              {
                icon: FileCheck2,
                text: "Актуальные условия",
              },
              {
                icon: Smartphone,
                text: "Удобно с телефона",
              },
            ].map(({ icon: Icon, text }) => (
              <div
                key={text}
      ...
      <footer className="border-t border-slate-200 bg-white">
        <div className="mx-auto max-w-6xl space-y-3 px-4 py-8 text-sm text-slate-600">
          ...
          <p>
            Перед оформлением изучайте договор и политику конфиденциальности кредитора.
          </p>
