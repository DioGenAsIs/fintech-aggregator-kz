      ...
      <header className="sticky top-0 z-50 border-b border-slate-200 bg-white/95 backdrop-blur">
        <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-4 py-3">
          ...
          <div className="flex items-center gap-2 rounded-xl border border-slate-200 bg-slate-100 p-1 text-sm">
            <Link
              href="/kk"
              className={`rounded-lg px-3 py-1.5 ${locale === "kk" ? "bg-white font-semibold text-slate-900" : "text-slate-600"}`}
            >
              {dict.lang.kk}
            </Link>
            <Link
              href="/ru"
              className={`rounded-lg px-3 py-1.5 ${locale === "ru" ? "bg-white font-semibold text-slate-900" : "text-slate-600"}`}
            >
              {dict.lang.ru}
            </Link>
          </div>
